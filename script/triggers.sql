...
BEGIN
    IF     (TG_OP = 'INSERT') THEN
       ...
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(new.id_empresa,new.id_local,new.id_inventario,new.id_imobilizado,hoje,'insert','fotos',new.id_usuario,histo_old,histo_atual,new.id_usuario,0);  
    ...
    ELSEIF (TG_OP = 'UPDATE') THEN
       ...
       histo_atual := json_agg(new.*);
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(new.id_empresa,new.id_local,new.id_inventario,new.id_imobilizado,hoje,'update','fotos',new.id_usuario,histo_old,histo_atual,new.id_usuario,0);  
    ...
    ELSIF  (TG_OP = 'DELETE') THEN 
       ...
       histo_atual := '';
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(old.id_empresa,old.id_local,old.id_inventario,old.id_imobilizado,hoje,'delete','fotos',old.id_usuario,histo_old,histo_atual,old.id_usuario,0);  
...
BEGIN
    IF    (TG_OP = 'INSERT') THEN
       ...
       histo_atual := json_agg(new.*);
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(new.id_empresa,new.id_filial,new.id_inventario,new.id_imobilizado,hoje,'insert','lancamentos',new.id_usuario,histo_old,histo_atual,new.id_usuario,0);  
   ...
   ELSEIF (TG_OP = 'UPDATE') THEN
       ...
       histo_atual := json_agg(new.*);
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(new.id_empresa,new.id_filial,new.id_inventario,new.id_imobilizado,hoje,'update','lancamentos',new.id_usuario,histo_old,histo_atual,new.id_usuario,0);  
   ...
   ELSIF  (TG_OP = 'DELETE') THEN 
       ...
       histo_atual := '';
       insert into auditorias(id_empresa,id_filial,id_inventario,id_imobilizado,dtacao,acao,escopo,id_usuario,histo_antes,histo_atual,user_insert,user_update)
		           values(old.id_empresa,old.id_filial,old.id_inventario,old.id_imobilizado,hoje,'delete','lancamentos',old.id_usuario,histo_old,histo_atual,old.id_usuario,0);  
