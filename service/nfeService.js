...
exports.getNfeByImobilizado = async function(
    id_empresa,
    id_filial,
    id_imobilizado,
    nfe,
    ...
    return nfeData.getNfeByImobilizado(
        id_empresa,
        id_filial,
        id_imobilizado,
        nfe,
...
//* CRUD - DELETE - SERVICE */
exports.deleteNfe = async function(
    id_empresa,
    id_filial,
    cnpj_fornecedor,
    razao_fornecedor,
