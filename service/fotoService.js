...
const TABELA = "FOTOS";
/* CRUD GET SERVICE */
exports.getFoto = async function(
    id_empresa,
    id_local,
    id_inventario,
    id_imobilizado,
...
exports.atualizaFoto = async function(
    foto,
    old_id_pasta,
    old_id_file,
    old_file_name
...
exports.updateFotoFileName = function(foto, new_name) {
    try {
        return fotoData.updateFotoFileName(foto, new_name);
    } catch (err) {
        throw err;
    }
};
...
//* CRUD - DELETE - SERVICE */
exports.deleteFoto = async function(
    id_empresa,
    id_local,
    id_inventario,
    id_imobilizado,
