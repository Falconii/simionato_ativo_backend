...
exports.getValores = function (params) {
  if (params) {
    ...
    if (params.orderby == "Imobilizado")
      orderby = "val.id_empresa,val.id_filial,val.id_imobilizado";
...
exports.insertValor = function (valor) {
  ...
  strSql = `insert into valores (
		 ...
		 ,   ${valor.id_filial} 
		 ,   ${valor.id_imobilizado} 
		 ,   ${shared.formatDateYYYYMMDD(valor.dtaquisicao)} 
		 ,   ${valor.vlraquisicao} 
		 ,   ${valor.totaldepreciado} 
		 ,   ${valor.vlrresidual} 
		 ,   ${valor.reavalicao} 
 ...
 returning * `;
  console.log("Valores ", strSql);
  return db.oneOrNone(strSql);
};
/* CRUD - UPDATE */
exports.updateValor = function (valor) {
  strSql = `update   valores set  
		     dtaquisicao = '${shared.formatDateYYYYMMDD(valor.dtaquisicao)}' 
 		 ...
 		 where id_empresa = ${valor.id_empresa} and  id_filial = ${
    valor.id_filial
  } and  id_imobilizado = ${valor.id_imobilizado}  returning * `;
  return db.oneOrNone(strSql);
};
/* CRUD - DELETE */
